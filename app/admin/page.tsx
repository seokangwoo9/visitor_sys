    ...
    <>
      ...
      <section className="grid gap-4 xl:grid-cols-5">
        <MetricCard
          ...
          note="People currently checked in"
          value={data.summary.currentVisitors}
        />
        <MetricCard
          icon={LineChart}
          label="Today's Visitors"
          note="People since midnight"
          value={data.summary.todayCheckIns}
        />
        <MetricCard
          icon={CalendarDays}
          label="This Week"
          note="People, week starts Monday"
          value={data.summary.weekVisitors}
        />
        <MetricCard
          icon={ArrowUpRight}
          label="This Month"
          note="People month-to-date"
    ...
    <>
      ...
      <section className="grid gap-6 xl:grid-cols-[1.35fr_1fr]">
        ...
        <InfoPanel
          ...
          items={[
            "Specified visitor columns include contact, people, company, PIC, pass, vehicle, check-in, check-out, duration, status, and IP.",
              ...
              {visitors.length > 0 ? (
                visitors.map((visitor) => (
                  <TableRow key={visitor.id}>
                    ...
                    <TableCell>{visitor.partySize}</TableCell>
                ...
                <TableRow>
                  <TableCell className="py-12 text-center text-text-secondary" colSpan={8}>
    ...
    <Dialog>
      ...
      <DialogContent className="max-h-[calc(100dvh-2rem)] w-[calc(100vw-2rem)] !max-w-none overflow-y-auto rounded-[1.75rem] border border-border bg-card p-5 shadow-xl shadow-admin-shadow/10 sm:!max-w-[calc(100vw-3rem)] sm:p-6 lg:!max-w-5xl xl:!max-w-6xl">
        ...
        <div className="mt-6 grid gap-3 md:grid-cols-2 lg:grid-cols-3">
          ...
          <VisitorDetailItem label="Number of People" value={visitor.partySize.toString()} />
...
function sumPartySize(visitors: AdminVisitorListItem[]): number {
  return visitors.reduce((total, visitor) => total + visitor.partySize, 0);
}
