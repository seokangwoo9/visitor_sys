    ...
    <>
      ...
      <section className="grid gap-4 xl:grid-cols-5">
        <MetricCard
          ...
          note="Visitor records currently checked in"
          value={data.summary.currentVisitors}
        />
        <MetricCard
          icon={LineChart}
          label="Today's Visitors"
          note="Visitor records since midnight"
          value={data.summary.todayCheckIns}
        />
        <MetricCard
          icon={CalendarDays}
          label="This Week"
          note="Visitor records, week starts Monday"
          value={data.summary.weekVisitors}
        />
        <MetricCard
          icon={ArrowUpRight}
          label="This Month"
          note="Visitor records month-to-date"
      ...
      <section className="grid gap-6 xl:grid-cols-[1.35fr_1fr]">
        <section className="rounded-[1.75rem] border border-border bg-card p-6 shadow-xl shadow-admin-shadow/10">
          ...
          <InfoPanel
            ...
            items={[
              "Specified visitor columns include contact, company, PIC, vehicle, check-in, check-out, duration, status, and safety acknowledgment.",
