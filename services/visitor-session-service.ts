...
export async function getActiveVisitorSession(
  ...
  return {
    ...
    safetyAcknowledged: sessionRecord.visitor.safetyAcknowledged,
    safetyAcknowledgedAt: sessionRecord.visitor.safetyAcknowledgedAt,
    safetyAcknowledgmentVersion: sessionRecord.visitor.safetyAcknowledgmentVersion,
    safetyAcknowledgmentVersionId: sessionRecord.visitor.safetyAcknowledgmentVersionId,
    pdpaConsent: sessionRecord.visitor.pdpaConsent,
    pdpaConsentedAt: sessionRecord.visitor.pdpaConsentedAt,
    pdpaConsentVersion: sessionRecord.visitor.pdpaConsentVersion,
    pdpaConsentVersionId: sessionRecord.visitor.pdpaConsentVersionId,
